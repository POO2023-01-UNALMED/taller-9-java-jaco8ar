...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public Calculator(){
		...
		StackPane sp =  new StackPane(rt, this.displayText); // primero rectangulo luego el texto de la calculadora
	...
	public void handle(ActionEvent event) {
		...
		switch(value){
			case "=":
				switch(operator){
					case "*":
						displayText.setText(Integer.toString(Integer.parseInt(number1) * Integer.parseInt(number2)));
						break;
					case "+":
						displayText.setText(Integer.toString(Integer.parseInt(number1) + Integer.parseInt(number2)));
						break;
